...
class MainMenu(Menu):
    ...
    def display_menu(self):
        ...
        while self.run_display:
            ...
            self.game.draw_text('Main Menu', 60, self.game.DISPLAY_W / 2, self.game.DISPLAY_H / 2 - 20)
...
class OptionsMenu(Menu):
    ...
    def check_input(self):
        if self.game.BACK_KEY:
            ...
            self.game.playing, self.run_display = False, False
...
class CreditsMenu(Menu):
    ...
    def display_menu(self):
        ...
        while self.run_display:
            ...
            self.game.draw_text('Made by me', 25, self.game.DISPLAY_W / 2, self.game.DISPLAY_H / 2 + 10)
            self.blit_screen()
